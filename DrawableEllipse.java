...
class DrawableEllipse extends DrawableObject {
    private Computer computer;
    
    public DrawableEllipse(Rectangle self) {
        originalRect = self;
    ...
    public void draw(Graphics g, Rectangle viewport, double zoom, int offsetX, int offsetY) {
        g.drawOval((int)((rect.x - viewport.x) * zoom) + offsetX, (int)((rect.y - viewport.y) * zoom) + offsetY, (int)(originalRect.width*zoom), (int)(originalRect.height*zoom));
    }
